...
root.configure(background = "powder blue") #background color of screen
root.resizable(width=False, height=False) #setting window size fixed
root.geometry("480x568+0+0") #setting geometry of window
...
################Creating buttons for Standard part#############
numberpad = "789456123"
i =0
btn=[]
for j in range(2,5):
...
#########Creating buttons for Scientifc part############
...
###################Menu#############################
#function to exit the calcualtor
def iExit():
...
menubar.add_cascade(label = "File", menu=filemenu) #name of menue
filemenu.add_command(label = "Standard Calculator", command=Standard) #first option
filemenu.add_command(label = "Scientific Calculator",command=Scientific) #second option
filemenu.add_separator() #separtor line

filemenu.add_command(label = "Exit", command=iExit) #last option



editmenu= Menu(menubar, tearoff=0)
menubar.add_cascade(label = "Edit", menu=editmenu) #name of menue
editmenu.add_command(label = "Cut") #first option
editmenu.add_command(label = "Copy") #second option
editmenu.add_separator() #separtor line

editmenu.add_command(label = "Paste") #last option

helpmenu= Menu(menubar, tearoff=0)
menubar.add_cascade(label = "Help", menu=helpmenu) #name of menue
helpmenu.add_command(label = "View Help") #first option
